...
int main(int argc, char* argv[]) {
    ...
    // Distribuie blocuri A și B din procesul 0
    if (rank == 0) {
        for (int r = 0; r < q; ++r) {
            for (int c = 0; c < q; ++c) {
                int dest_rank;
    ...
    // Colectează matricea rezultată în procesul 0
    double* C = nullptr;
    if (rank == 0)
